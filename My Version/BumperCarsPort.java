...
public class BumperCarsPort implements Runnable, ActionListener, Constants, KeyListener{
	BumperCarsUI ui;
	String server;
	String name;
	String role;
	...
	public BumperCarsPort() throws Exception{
		socket.setSoTimeout(100);
	}

	public void setUI(BumperCarsUI ui) {
		this.ui = ui;
	}
