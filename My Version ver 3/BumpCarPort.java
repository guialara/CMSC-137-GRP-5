...
public class BumpCarPort implements Runnable, ActionListener, Constants, KeyListener{
	BumpCarUI ui;
	String server;
	String name;
	String role;
	...
	public BumpCarPort() throws Exception{
		socket.setSoTimeout(100);
	}

	public void setUI(BumpCarUI ui) {
		this.ui = ui;
	}
